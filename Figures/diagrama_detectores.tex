...
\begin{tikzpicture}[
    ...
    % Estilos das labels
    titlelabel/.style={font=\large\sffamily\bfseries, text=labelcolor},
    stagelabel/.style={font=\scriptsize\sffamily\bfseries, text=white, fill=stagecolor, rounded corners=2pt, inner sep=3pt},
    sublabel/.style={font=\scriptsize\sffamily, text=sublabelcolor},
...
\begin{scope}[shift={(-4, 0)}]
    ...
    \node[stagelabel, anchor=east] at (-1.6, -1.6) {Estágio 1};
    \node[backboneblock] (bb2) at (0, -2.7) {Backbone};
    \node[rpnblock] (rpn) at (0, -3.8) {RPN};
    \node[sublabel, anchor=west] at (1.5, -3.8) {Propostas de regiões};

    \node[roiblock] (roi) at (0, -5.0) {ROI Pooling};
    \node[stagelabel, anchor=east] at (-1.6, -5.0) {Estágio 2};
...
\begin{scope}[shift={(4, 0)}]
    ...
    \node[sublabel, anchor=west] at (1.5, -3.8) {Predição em grid};
    ...
    \node[sublabel, rotate=90] at (-2.2, -4.0) {Multi-escala};
