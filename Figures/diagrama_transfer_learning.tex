...
\begin{tikzpicture}[
    ...
    sectionlabel/.style={font=\normalsize\sffamily\bfseries, text=labelcolor},
    sublabel/.style={font=\scriptsize\sffamily, text=labelcolor}
]
...
\node[datasetbox, fill=inputcolor!10, draw=inputcolor, line width=1pt] (source_data) at (0, 1.5) {};
\node[font=\small\sffamily\bfseries, text=inputcolor!80!black] at (0, 1.8) {COCO};
\node[font=\scriptsize\sffamily, text=labelcolor] at (0, 1.2) {Milhões de imagens};
...
% ============================================================================
\draw[transferarrow] (1.8, -1.0) -- node[above, font=\small\sffamily\bfseries, text=skipcolor] {Transfer} node[below, font=\scriptsize\sffamily, text=skipcolor] {Learning} (4.2, -1.0);
...
\node[datasetbox, fill=headcolor!10, draw=headcolor, line width=1pt] (target_data) at (6.0, 1.5) {};
\node[font=\small\sffamily\bfseries, text=headcolor!80!black] at (6.0, 1.8) {Dataset EPI};
\node[font=\scriptsize\sffamily, text=labelcolor] at (6.0, 1.2) {Classes específicas};
...
\begin{scope}[shift={(9.0, 0.5)}]
    \node[font=\small\sffamily\bfseries, text=labelcolor] at (0, 0.8) {Legenda:};

    \node[layerfrozen, minimum width=1.2cm] at (0, 0.3) {};
    \node[font=\scriptsize\sffamily, text=labelcolor, anchor=west] at (0.7, 0.3) {Congelada};

    \node[layerfinetune, minimum width=1.2cm] at (0, -0.2) {};
    \node[font=\scriptsize\sffamily, text=labelcolor, anchor=west] at (0.7, -0.2) {Ajustada};

    \node[layernew, minimum width=1.2cm] at (0, -0.7) {};
    \node[font=\scriptsize\sffamily, text=labelcolor, anchor=west] at (0.7, -0.7) {Nova};
\end{scope}
...
\node[font=\scriptsize\sffamily\itshape, text=skipcolor] at (3.0, 1.2) {Pesos transferidos};
