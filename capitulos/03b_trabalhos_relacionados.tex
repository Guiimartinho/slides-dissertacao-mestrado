...
\begin{frame}{Trabalhos Relacionados}
  ...
  \begin{center}
    \begin{tikzpicture}
      \node[fill=stagecolor!10, rounded corners=3pt, inner sep=6pt, text width=0.92\textwidth, align=center] {
        {\footnotesize Trabalhos existentes focam em \mbox{\textbf{poucas classes}} (3--5) com \textbf{modelo \'{u}nico}. Nenhum combina infer\^{e}ncia em \mbox{\textbf{cascata multidom\'{i}nio}} com \textbf{computa\c{c}\~{a}o de borda}.}
      };
    \end{tikzpicture}
  \end{center}
  \vfill
