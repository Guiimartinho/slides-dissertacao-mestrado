...
\begin{frame}{Conclusões}
  ...
  \begin{columns}[c]
    \begin{column}{0.22\textwidth}
      \raggedleft
      {\fontsize{14}{16}\selectfont\textcolor{inputcolor}{\textbf{\mbox{0,71--0,84}}}}
    \end{column}
    \begin{column}{0.02\textwidth}
      \centering
      \textcolor{arrowcolor}{\rule{0.4pt}{1.5em}}
...
\begin{frame}{Impacto e Aplicabilidade Real}
  ...
  \begin{columns}[c]
    ...
    \begin{column}{0.48\textwidth}
      ...
      \begin{itemize}\setlength{\itemsep}{0.5mm}\footnotesize
        \item \textbf{Grandes construtoras}
          \begin{itemize}\setlength{\itemsep}{0pt}\scriptsize
            \item Alertas 24h em tempo real
          \end{itemize}
        \item \textbf{Obras públicas}
          \begin{itemize}\setlength{\itemsep}{0pt}\scriptsize
            \item Fiscalização NR-18 automatizada
          \end{itemize}
        \item \textbf{Canteiros remotos}
          \begin{itemize}\setlength{\itemsep}{0pt}\scriptsize
            \item Edge AI operando a 24W
          \end{itemize}
        \item \textbf{Seguradoras}
          \begin{itemize}\setlength{\itemsep}{0pt}\scriptsize
            \item Avaliação de risco automatizada
          \end{itemize}
      \end{itemize}
    \end{column}
  \end{columns}
